...
?>
<div class="p-4">
<a class="btn btn-warning" href="contacts">Manage Contact</a>
...
<?php
	...
	$html.=select_field(["label"=>"Contact Category","name"=>"cmbContactCategoryId","table"=>"contact_categorys","value"=>"$contact->contact_category_id"]);
