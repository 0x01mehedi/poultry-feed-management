        ...
        <div class="invoice p-3 mb-3">
              ...
              <table class="table table-striped">
                <thead>
                  ...
                  <tr>
                    ...
                    <th>
                      <?php
                      echo Product::html_selectRawmaterials();
                      ?>
                    </th>
          ...
          <div class="row no-print">
            <div class="col-12">
              ...
              <button type="button" id="btnProcessPurchase" class="btn btn-danger float-right"><i class="far fa-credit-card"></i> Process Purchase </button>
              <!-- <button type="button" class="btn btn-secondary float-right" style="margin-right: 5px;" onclick="generatePDF()"> <i class="fas fa-download"></i> Generate PDF</button> -->
            </div>
          </div>
        </div>
        <!-- /.invoice -->
