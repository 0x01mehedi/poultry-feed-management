              ...
              <table class="table table-striped">
                <thead>
                  ...
                  <tr>
                    ...
                    <th>
                      <?php
                      echo Product::html_select_Finishedgoods();
                      ?>
                    </th>
                    ...
                    <th></th>
                    <th><input class="btn btn-info" type="button" id="btnAddToCart" value=" Add " /></th>
                  </tr>
                </thead>
                <tbody id="items">
    ...
    function printCart() {
      ...
      if (orders != null) {
        ...
        orders.forEach(function(item, i) {
          ...
          $html += "</td>";
          $html += "<td>";
          $html += "<input type='button' class='delete' data-id='" + item.item_id + "' value='Del'/>";
          $html += "</td>";
          $html += "</tr>";
          $bill += $html;
          sn++;
