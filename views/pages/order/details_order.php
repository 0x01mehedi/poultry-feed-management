          ...
          <div class="col-12">
            ...
            <div class="invoice p-3 mb-3">
              ...
              <div class="row mb-3">
                ...
                <div class="col-12">
                <small class="float-right mt-0">Date: <?php echo date('d M Y', strtotime($order->order_date)); ?></small>
              ...
              <div class="row">
                ...
                <!-- /.col -->
                <div class="col-6">
                  <p class="lead">Amount Due: <?php echo date('d M Y', strtotime($order->order_date)); ?></p>
