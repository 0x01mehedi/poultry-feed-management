...
if(isset($_POST["btnDetails"])){
	$product=Product::findDetails($_POST["txtId"]);
}
?>
<div class="p-4">
...
<?php
	$html="";
		...
		$html.="<tr><th>Product Category Id</th><td>$product->category</td></tr>";
		$html.="<tr><th>Feed Id</th><td>$product->feed</td></tr>";
		...
		$html.="<tr><th>Uom Id</th><td>$product->uom</td></tr>";
		...
		$html.="<tr><th>Product Type Id</th><td>$product->product_type</td></tr>";
