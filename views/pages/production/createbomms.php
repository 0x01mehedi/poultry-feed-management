...
<div class="section">
      <div class="row">
          <div class="col-12 p-3">
              ...
              <div class="shadow-lg" style="background-color:#828282">

                <table class="table">

                 <tr><td colspan="2"><h2 class="d-flex justify-content-center">Create BOM</h2></td></tr> 

                 

                 <tr><td> Delivery Date</td><td> <input class="form-control" type="date" id="deliveryDate" ></td></tr>

                 <tr><td>BOM Code: </td><td><input type="text" id="code" /></td></tr>

                 <tr><td>Name: </td><td><input type="text" id="name" /></td></tr>

                 <tr><td>Product: </td><td><?php
                       echo Product::html_selectOrder("cmbProduct");
                     ?></td></tr>                    
                            

                <tr><td>Qty</td><td> <input type="text" class="cal" id="qty" /></td></tr>   
                <tr><td>Labour</td><td><input type="text" id="labour" /></td></tr> 
