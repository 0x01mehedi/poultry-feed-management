...
";
	...
	static function html_select($name="cmbWarehouse"){
		global $db,$tx;
		$html="<select id='$name' name='$name' class='p-5'> ";
	...
	static function html_table($page = 1,$perpage = 10,$criteria="",$action=true){
		...
		$html="<table class='table'>";
			$html.="<tr><th colspan='3'><a class=\"btn btn-warning\" href=\"create-warehouse\">New Warehouse</a></th></tr>";
		if($action){
		...
		while($warehouse=$result->fetch_object()){
			...
			if($action){
				...
				$action_buttons.= action_button(["id"=>$warehouse->id, "name"=>"Edit", "value"=>"Edit", "class"=>"secondary", "url"=>"edit-warehouse"]);
