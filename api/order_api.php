...
class OrderApi{
  ...
  static function save($data){  
    ...
    $order_date=date("Y-m-d H:i:s",strtotime($order_date));//convert date into mysql format
    $due_date=date("Y-m-d H:i:s",strtotime($due_date));//convert date into mysql format
